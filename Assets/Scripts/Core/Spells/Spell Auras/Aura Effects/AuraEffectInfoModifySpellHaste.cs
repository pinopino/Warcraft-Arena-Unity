...
{
    [CreateAssetMenu(fileName = "Aura Effect Modify Spell Haste", menuName = "Game Data/Spells/Auras/Effects/Spell Haste Modifier", order = 2)]
    public class AuraEffectInfoModifySpellHaste : AuraEffectInfo
    {
        [SerializeField, Range(-500f, 500.0f)] private float castTimePercentageModifier;
