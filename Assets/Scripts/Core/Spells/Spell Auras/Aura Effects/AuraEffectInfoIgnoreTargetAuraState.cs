...
{
    [CreateAssetMenu(fileName = "Aura Effect Ignore Target Aura State", menuName = "Game Data/Spells/Auras/Effects/Ignore Target Aura State", order = 4)]
    public class AuraEffectInfoIgnoreTargetAuraState : AuraEffectInfo
    {
        [SerializeField] private AuraStateType ignoredState;
